...
function new(callRestart, callMenu)
	...
	local tfTitle = createText("В.И.П.П.", 30, {255/30,30/255,91/255})
	tfTitle.x = 0;
	tfTitle.y = 70;
	localGroup:insert(tfTitle);
	local tfTitle = createText("для MY.GAMES", 20, {128/255,137/255,137/255})
	tfTitle.x = 0;
	tfTitle.y = 105;
	localGroup:insert(tfTitle);
	local tfTitle = createText("Mobile GameJam 2021", 20, {128/255,137/255,137/255})
	tfTitle.x = 0;
	tfTitle.y = 130;
	localGroup:insert(tfTitle);
